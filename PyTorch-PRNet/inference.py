...
def main(args):
    ...
    for i, image_path in enumerate(image_path_list):
        ...
        # pos = prn.net_forward(toTensor(image).unsqueeze(0))
        #
        ...
        for i,img in enumerate(images):
            ...
            pos = prn.net_forward(toTensor(img).unsqueeze(0))
        ...
        #
        #     # image = cv2.imread("./test_data/original.jpg")
        #     # [h, w, c] = image.shape
        #     # pos = np.load("./test_data/IBUG_image_119_8.npy")
        #
        #     # path = os.path.join(save_folder, name + '_' + i + '.jpg')
        #     # print(path)
        #     if pos is None:
        #         continue
        #     kpt = prn.get_landmarks(pos)
        #     cv2.imwrite(os.path.join(save_folder, name + '_'+ str(i) +'.jpg'),plot_kpt(img, kpt))
