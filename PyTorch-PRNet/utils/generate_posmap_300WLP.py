...
def generate_batch_sample(input_dir, save_folder='./300WLP'):
    ...
    for idx, item in enumerate(os.listdir(input_dir)):
        if 'jpg' in item:
            ...
            run_posmap_300W_LP(bfm, img_path, mat_path, save_folder, idex + base)
            print("Number {} uv_pos_map was generated,total {}!".format(idex,idex+base))
            idex +=1
...
if __name__ == '__main__':
    ...
    save_dir = os.path.join('../', home_path, '/home/ubuntu/hdd1/lxc/test/')

    generate_batch_sample(save_folder=save_dir,
